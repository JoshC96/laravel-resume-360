<template>
    <header class=" flex items-center justify-between px-6 py-2 bg-white border-b-4 border-indigo-600">
        <div class="flex items-center">
            <button @click="sidebarStore.toggleSidebar" class="text-gray-500 focus:outline-none lg:hidden">
                <svg class="hamburger w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
